    ...
    ElementsKit_Helper.megaMenuAjaxLoad = function(t) {
        ...
        i.length && !t.hasClass("ekit-ajax-loading") && e.ajax({
            ...
            beforeSend: function() {
                ...
                n.toggleClass("icon icon-down-arrow1 eicon-loading eicon-animation-spin"),
            ...
            success: function(s) {
                ...
                i.replaceWith(s),
                n.toggleClass("eicon-loading eicon-animation-spin icon icon-down-arrow1").removeAttr("style"),
    ...
    let n = {
        ...
        Client_Logo: function(e) {
            ...
            n.arrows && (n.navigation = {
                prevEl: e.find(".slick-prev").get(0),
                nextEl: e.find(".slick-next").get(0)
            }),
            n.dots && (n.pagination = {
        ...
        Testimonial_Slider: function(e) {
            ...
            n.dots && (n.pagination = {
                ...
                renderCustom: (e,t,n)=>{
                    var i = "";
                    for (let e = 1; e <= n; e++)
                        i += '<li class="' + (t === e ? " swiper-pagination-bullet-active slick-active" : "swiper-pagination-bullet") + '"><button type="button" tabindex="0" role="button" aria-label="Go to slide' + e + '" class="">' + e + "</button></li>";
                    return i
                }
            });
            let i = e.find(`.${t.config.swiperClass}`);
        ...
        Back_To_Top: function(t) {
            const n = t.find(".ekit-btt__button")
              , {offset_top: i, show_after: s, show_scroll: o, style: a, fg: l, bg: r} = t.find(".ekit-btt").data("settings");
