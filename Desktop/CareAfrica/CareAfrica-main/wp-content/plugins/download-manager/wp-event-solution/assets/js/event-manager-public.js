jQuery(document).ready(function($) {
    ...
    function getInputFieldWithAttr(selector) {
        ...
        $(selector).find('input').each(function() {
            var $_this = $(this);
            if (($_this.attr("data-etn_required") === "required") && ($_this.attr('type') === "checkbox" || $_this.attr('type') === "radio")) {
            ...
            $(".attende_form").on("keyup change", value, function() {
                ...
                if (typeof response !== "undefined" && response.message !== 'success') {
                    ...
                    if (get_type == 'radio' || get_type == 'checkbox') {
                        $_this.parents('.etn-' + get_type + '-field-wrap').find('.etn-attendee-extra-fields').removeClass("attendee_error");
                    }
                }
    ...
    function get_error_message(type, value, input_name='') {
        ...
        if (type !== 'radio' || type !== 'checkbox') {
            ...
            if ($(input_name).is(':checked')) {
                if (type == 'radio') {
                    $(this).parents('.etn-radio-field-wrap').find('.etn-attendee-extra-fields').removeClass("attendee_error");
                } else if (type == 'checkbox') {
                    $(this).parents('.etn-checkbox-field-wrap').find('.etn-attendee-extra-fields').removeClass("attendee_error");
                }
            } else {
                $(this).addClass("attendee_error");
            }
...
function etn_ticket_quantity_update($, $scope) {
    ...
    function ticket_price_cal($this, single_ticket, variations) {
        ...
        for (let index = 0; index < form_length; index++) {
            ...
            var sub_ticket_price = formatter.format(ticket_price).replace(/,/g, thousand_separator).replace(/\./g, decimal_separator);
            single_ticket.find('._sub_total_' + index).text(sub_ticket_price);
            total_price += ticket_price;
            total_qty += quantity;
        }
        const total_total_price_format = formatter.format(total_price).replace(/,/g, thousand_separator).replace(/\./g, decimal_separator);
