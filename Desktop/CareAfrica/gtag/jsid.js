    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 12,
                "vtp_instanceDestinationId": "G-VE49F7WSTE",
                "tag_id": 18
            }, {
...
*/
    ...
    oi.me = Number("0") || 0;
    oi.ia = "dataLayer";
    oi.Uj = "ChEI8MeaqAYQ+76Xg+bkj5SwARIlAOf/cviU0QeIBzzbMU7Dc61RpbvGpi/Xs9VUPPyIElg42iUo3hoCUsA\x3d";
    var ri = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    var kj;
    try {
        kj = JSON.parse(xb("eyIwIjoiUlciLCIxIjoiUlctMDEiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5ydyIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        M(123),
        jj(2),
        kj = {}
    ...
    ;function fz() {
        var a = ["&cv=1", "&rv=" + oi.Qg, "&tc=" + uf.filter(function(b) {
            return b
        }).length];
      ...
      , MB = function(a, b) {
        ...
        function f(G) {
            ...
            case 1:
                ...
                y = a.getPlaybackRate();
                b.Wg ? $w(t.createEvent("start")) : t.bd();
        ...
        function k(G) {
            ...
            case 3:
                ...
                a.getCurrentTime() && (b.Vg ? $w(t.createEvent(F)) : t.bd());
                q();
                return m;
            case -1:
                return e(G);
        ...
        function n() {
            ...
            b.Ug && $w(t.createEvent("complete", 1));
            return e(-1)
        }
        function p() {}
        function q() {
    ...
    function wD() {
        ...
        a.set("containerId", 'G-VE49F7WSTE'),
        a.set("version", '1'),
    ...
    var AE = function(a, b) {
        ...
        Q(99) && (jm(b.s) && (Q(81) || yC()) ? Q(52) && (a.npa = "0") : a.npa = "1")
    }
      , DE = function(a) {
    ...
    JE))
      ...
      , LE = function(a, b, c) {
        ...
        var q = a.h[N.g.Na] || {};
        Q(99) || (jm(a.s) && (Q(81) || yC()) ? Q(52) && (q._npa = "0") : q._npa = "1");
      ...
      , ZE = function(a) {
        if (TD(a)) {
            var b = function(d) {
              ...
              , c = U(a.s, N.g.wa);
            void 0 !== c ? (b(c),
            Q(108) && (a.h[N.g.be] = "c")) : b(a.metadata.user_data);
    ...
    aa.jm = function(a) {
        ...
        try {
            ...
            if (0 <= tn.Yk.replace(/\s+/g, "").split(",").indexOf(a.eventName))
                a.isAborted = !0;
            else {
                var f = VD(a);
            ...
            var q = this.Cj, r;
            U(a.s, N.g.Ab) && (R(N.g.R) || U(a.s, N.g.Za) || (a.h[N.g.Ri] = !0));
            var t;
            var u;
            u = void 0 === u ? 3 : u;
            ...
            if (a.eventName !== N.g.na)
                ...
                var y = vE(a)
                  , A = xE(a);
                r = Q(55) && Object.keys(y).length ? y : A
            }
            q.call(this, r);
            ...
            sa && sa.th && (a.metadata.join_timer_sec = Math.max(0, sa.th - Math.max(0, da - sa.Le)));
            var Fa = !1;
            ...
            if (Fa)
                ...
                I.zl(a);
            else if (I.pl() > Ja || a.eventName == N.g.ic)
                sa.nd = !0;
            ...
            if (!U(a.s, N.g.Jb) || !U(a.s, N.g.vb)) {
                ...
                var Ji = a.copyToHitData, nH = N.g.Ea, Ki;
                a: {
                ...
                Q(85) && $p() && a.copyToHitData(N.g.hf, "1")
            }
            a.metadata.create_dc_join = !1;
            a.metadata.create_google_join = !1;
            if (!(Q(60) && TD(a) || a.metadata.is_merchant_center || !1 === U(a.s, N.g.qb)) && xC() && R(N.g.I)) {
                var Li = wp(a, N.g.eb, U(a.s, N.g.eb));
                Li = Li || SD(a);
                (a.metadata.is_session_start || U(a.s, N.g.ef)) && (a.metadata.create_dc_join = !!Li);
                var uv;
                uv = a.metadata.join_timer_sec;
                Li && 0 === (uv || 0) && (a.metadata.join_timer_sec = 60,
            ...
            if (void 0 !== U(a.s, N.g.Sc))
                ...
                var yv = U(a.s, N.g.Od), Km, Mi;
                a: {
                    if (uE) {
                        var Lm = rE(a) || {};
                        if (Lm && Lm[N.g.T])
                            for (var zv = Bn(Dn(a.h[N.g.Ea]), "host", !0), Ni = Lm[N.g.T], Mg = 0; Mg < Ni.length; Mg++)
                                if (Ni[Mg]instanceof RegExp) {
                                    if (Ni[Mg].test(zv)) {
                                        Mi = !0;
                                        break a
                                    }
                                } else if (0 <= zv.indexOf(Ni[Mg])) {
                                    Mi = !0;
                                    break a
                                }
                    }
            ...
            TD(a) && (Kj() || Q(44)) && ((Lj() || Q(48)) && WD(a, "gcd", om(a.s)),
            ...
            Q(73) && TD(a) && (a.h[N.g.Ji] = mj() || lj());
            if (TD(a) && Q(83)) {
                var Gv = Ei;
                Gv && WD(a, "tft", Number(Gv))
            }
            Q(102) && TD(a) && a.metadata.speculative && WD(a, "sp", 1);
            a: if (Q(7))
                if (!pn(z))
                    M(87);
                else if (void 0 !== rn) {
            ...
            zp(a);
            ZE(a);
            Q(102) && TD(a) && (a.metadata.speculative = !1);
            var Lv = U(a.s, N.g.vb);
            Lv && aE(12);
            ...
            var sH = this.Cj, Nv, tH = this.h, Qm;
            a: {
                var Rm = qE(a);
                if (Rm) {
                    if (oE(Rm, a)) {
    ...
    ;var pF = function(a) {
        if (Q(65) && "prerendering"in B ? B.prerendering : "prerender" === B.visibilityState)
            return !1;
        a();
        return !0
    }
        ...
        if (!pF(a)) {
            var b = !1
              , c = function() {
                ...
                Q(65) && Qc(B, "prerenderingchange", c),
                M(55))
            };
            Pc(B, "visibilitychange", c);
            Q(65) && Pc(B, "prerenderingchange", c);
            M(54)
        }
    };
    var sF = function(a, b) {
    ...
    function tF(a, b, c) {
        ...
        d.lm(function() {
            XD = !0;
            Wv.flush();
            1E3 <= d.Ef() && Ec.sendBeacon && Yv(N.g.vd, {}, a.id, f);
            b.flush();
            d.Dj(function() {
                XD = !1;
                d.Dj()
    ...
    function() {
        ...
        (function(d) {
            ...
            e[N.g.fg] = d.vtp_dynamicEventSettings;
            e[N.g.eb] = 1 === d.vtp_googleSignals;
            e[N.g.rg] = d.vtp_foreignTld;
